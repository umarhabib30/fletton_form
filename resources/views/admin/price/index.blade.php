                    ...
                    <form action="{{ route('admin.price.update') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="aerial_chimney_cost" name="aerial_chimney_cost" type="number" step="any"
                                    min="0" class="form-control" value="{{ @$price->aerial_chimney_cost }}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="insurance_cost">Insurance Cost</label>
                                <input id="insurance_cost" name="insurance_cost" type="number" step="any"
                                    min="0" class="form-control" value="{{ @$price->insurance_cost }}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="thermal_image_cost">Thermal Image Cost</label>
                                <input id="thermal_image_cost" name="thermal_image_cost" type="number" step="any"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="extra_sqft_cost" name="extra_sqft_cost" type="number" step="any"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="extra_room_cost" name="extra_room_cost" type="number" step="any"
